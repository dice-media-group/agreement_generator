...
class ApprovalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create approval" do
    assert_difference('Approval.count') do
      post approvals_url, params: { approval: { agreement_id: @approval.agreement_id, status: @approval.status } }
    end
  ...
  test "should update approval" do
    patch approval_url(@approval), params: { approval: { agreement_id: @approval.agreement_id, status: @approval.status } }
